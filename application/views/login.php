...
<head>
    ...
    <title>Pengajuan user | Login</title>
                    ...
                    <section id="login-body" class="pt-3" >
                        <div class="card border-0 shadow pt-3" style="background-image: url('../assets/img/bg1.png'); opacity: 0.9;">
                            <div class="card-header bg-transparent border-bottom-0 pb-0 text-center" >
                                <img src="<?= base_url('assets/img/logo1.png') ?>" alt="Logo Indoexpress" class="img-fluid mx-auto d-block">
                                <div class="mt-3">
                                    <span class="card-info text-center">Masuk Untuk Melakukan Pengajuan</span>
                                </div>
                            </div>
                            <div class="card-body" >
