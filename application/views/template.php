...
<body>
    <div class="wrapper">
        <div class="sidebar" data-image="<?= base_url('assets/img/sidebar-5.jpg') ?>" data-color="blue">
            <!--
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                        <img src="<?= base_url('assets/img/logo2.png') ?>" alt="" class="img-fluid" width="250">
                    </a>
                </div>
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class=" container-fluid">
                    <a class="navbar-brand">Sistem Pengajuan User </a>
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; <?= date('Y') ?> <a href="https://camatmandau.bengkaliskab.go.id/">DISKOMINFO PELALAWAN</a>
                        </p>
                    </nav>
                </div>
            </footer>
