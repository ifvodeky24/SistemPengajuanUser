                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nik" id="nik" value="<?= $user->nik ?>" class="form-control" placeholder="NIP" disabled required="reuqired" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                ...
                <div class="card-footer">
                    <div class="row w-100">
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                            ...
                            <button type="submit" class="btn btn-primary btn-block">Edit <i class="fa fa-save"></i></button>
                        </div>
                    </div>
                </div>
            </form>
